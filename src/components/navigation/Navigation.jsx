...
const Navigation = () => {
  ...
  return (
    <>
      ...
      <div className="bg-stone-800 h-16 text-xl flex justify-between items-center px-16 py-10 text-stone-200 border-b-2 border-blue-600">
      ...
      <div className={` z-50 bg-stone-700 h-screen z-50 w-1/4 absolute right-0 flex flex-col transition ease-in-out delay-15 duration-30 ${navOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div className="flex justify-center bg-stone-800 py-4 my-5">
